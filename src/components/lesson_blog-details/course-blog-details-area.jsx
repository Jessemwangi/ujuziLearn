              ...
              <div className="blog-details-content">
                <div className="entry-content">
                  ...
                  <ul className="blog-meta">
                    ...
                    <li>
                      <i className="icon-28"></i> Topics{" "}
                      {curriculum_lesson_headers?.length}
                    </li>
                  </ul>
                  {intro_pic?.url && (
                ...
                {curriculum_lesson_headers?.map(
                  ({
                    ...
                    <div key={id}>
                      ...
                      <div>
                        <MarkoutOutPut
                          content={course_curriculum_lesson_header_content}
                        />
                      </div>
                      ...
                      {content_2 && <MarkoutOutPut content={content_2} />}
                          ...
                          <div className="inner">
                            <div className="thumbnail">
                              <img
                                src={
                                  content_img?.url ||
                                  "https://res.cloudinary.com/dk4ruyonq/image/upload/v1715297668/video_Thumb_d8700518fc.png"
                                }
                                alt="Watch Video"
                                width={100}
                              />
                              ...
                              <div className="col-lg-6">
                                <div className="blog-pagination-list prev-post">
                                  ...
                                  >
                                    ...
                                    <span>
                                      {prevLesson.curriculum_lesson_title ||
                                        "Previous Lesson"}
                                    </span>
                                  </Link>
                                </div>
                              ...
                              <div className="col-lg-6">
                                <div className="blog-pagination-list next-post">
                                  ...
                                  >
                                    ...
                                    <span>
                                      {nextLesson.curriculum_lesson_title ||
                                        "Next Lesson"}
                                    </span>
                                  </Link>
                                </div>
