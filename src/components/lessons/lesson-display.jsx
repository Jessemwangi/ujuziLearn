...
const LessonDisplay = ({ course }) => {
  const { id,short_desc,
    ...
    courses_weekly_curricula,weekly_curriculum_intro,course_reviews,course_ratings} = course
    return (
...
<LessonListsAccordion weekly_curriculum={courses_weekly_curricula}/>
 ...
 */}
                                    ...
                                    <div className="course-tab-content">
                                        ...
                                        <div className="course-instructor" key={id}>
                                            <div className="thumbnail">
                                                <img src={`${server}${attrib?.instructor_img?.formats?.thumbnail?.url}`} alt="team images" />
                                            </div>
                                            <div className="author-content">
                                                ...
                                                <ul className="social-share">
                                                        ...
                                                        <li >
                                                            <a href={attrib?.instructor_linkedIn} target='_blank'>
                                                        ...
                                                        <li >
                                                            <a href={attrib?.instructor_youtube} target='_blank'>
                            ...
                            <div className="course-review" data-sal-delay="150"  data-sal-duration="800">
                                ...
                                <p>{course_ratings?.length} average rating based on {course_ratings?.length} rating</p>
                                <div className="row g-0 align-items-center">
                                    <div className="col-sm-4">
                                    <div className="rating-box">
                                                        <div className="rating-number">{course_ratings?.length}</div>
                                    ...
                                    <div className="col-lg-8">
                                        ...
                                        { course_ratings?.map(({id,rating}) =>
                                                <SingleProgressbar key={id} value={'100'} rating_value={rating * 10} />)}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <CourseDetailsSidebarNoStart  lessons={courses_weekly_curricula} course={course} details_2={true} />
                    </div>
                </div>
            </div>
        </section>
